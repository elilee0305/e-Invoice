...
<tr>
	<td>Attention</td><td><input type="text" name="customerAttentionValue" id="customerAttentionValue" size="40" maxlength="100" value="<?php if(($duplicateStatus==1)&&($customerID <> 0)){echo $rowCustomerInfo[3];}?>"></td>
	<td></td><td>Date</td>
	<?php 
		...
		if(mysqli_num_rows($resultPurchaseOrderDetailInfo) > 0){
			...
			while($rowPurchaseOrderDetailInfo = mysqli_fetch_row($resultPurchaseOrderDetailInfo)){
				...
				if($rowPurchaseOrderDetailInfo[10] == 1){			
					...
					echo "<td><textarea class='styled' id='$idNamePHP' style='width: 480px;' name='noCol2[]' maxlength='200' ondblclick='popupwindow()'>$rowPurchaseOrderDetailInfo[1]</textarea></td>";
				}
