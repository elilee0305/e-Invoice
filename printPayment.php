<?php 	
	...
	//get payment info
	$sqlPaymentInfo = "SELECT paymentMethod_name, payment_no, payment_date, payment_chequeInfo, payment_remark, 
	payment_amount FROM tbpaymentmethod, tbpayment 
	WHERE (paymentMethod_id = payment_paymentMethodID) AND (payment_id = '$paymentID')";
...
<tr><td colspan="5" align="right"><b>RECEIPT</b></td></tr>
...
<tr><td colspan="2" style="border-top:1px solid #cbcecb;border-left:1px solid #cbcecb;border-right:1px solid #cbcecb;"><b><?php echo $resultCustomerInfo2[0]?></b></td><td></td><td style="border-top:1px solid #cbcecb;border-left:1px solid #cbcecb;"><b>Receipt No</b></td><td style="border-top:1px solid #cbcecb;border-right:1px solid #cbcecb;"><?php echo $resultPaymentInfo2[1];?></td></tr>
...
<tr><td style="border-bottom:1px solid #cbcecb;border-left:1px solid #cbcecb;"><b>Email</b></td><td style="border-bottom:1px solid #cbcecb;border-right:1px solid #cbcecb;"><?php echo $resultCustomerInfo2[3];?></td><td></td><td></td><td></td></tr>
...
<td colspan="5" align="left"><div><?php echo ""; ?></div></td></tr>
...
<p><input type="button" class="noPrint" onclick="JavaScript:window.print();return false;" value="Print Receipt"></p>
