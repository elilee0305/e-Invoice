...
<script>
	function createPDF(x,y){
		...
		var url = 'printInvoicePDF.php';
		var params = 'idInvoice=' + invoiceID + '&idCustomer=' + customerID;
		...
		xhr.onreadystatechange = function(){
			if(xhr.readyState === 4){
				...
				if(xhr.status === 200){
                    ...
                    link.href = url;
					var fileName = "invoice" +  "_" + Date.now() + ".pdf";
...
<tr><td colspan="5" align="right"><b>INVOICE</b></td></tr>
...
<tr><td colspan="2" style="border-top:1px solid #cbcecb;border-left:1px solid #cbcecb;border-right:1px solid #cbcecb;"><b><?php echo $resultCustomerInfo2[0]?></b></td><td ></td><td style="border-top:1px solid #cbcecb;border-left:1px solid #cbcecb;"><b>Invoice No</b></td><td style="border-top:1px solid #cbcecb;border-right:1px solid #cbcecb;"><?php echo $rowInvoiceInfo[0];?></td></tr>
<tr><td colspan="2" style="border-left:1px solid #cbcecb;border-right:1px solid #cbcecb;"><?php echo nl2br($resultCustomerInfo2[2]);?></td><td></td><td valign="top" style="border-left:1px solid #cbcecb;border-bottom:1px solid #cbcecb;"><b>Date</b></td><td valign="top" style="border-right:1px solid #cbcecb;border-bottom:1px solid #cbcecb;"><?php echo date("d/m/y",strtotime($rowInvoiceInfo[1]))?></td></tr>


<tr><td style="border-left:1px solid #cbcecb;"><b>Tel</b></td><td  align="left" style="border-right:1px solid #cbcecb;"><?php echo $resultCustomerInfo2[1]?></td><td ></td><td><b>Terms</b></td><td>
<?php 
	if($rowInvoiceInfo[15]==0){$terms="";}else{$terms = $rowInvoiceInfo[15]."&nbsp;Days";}
	echo $terms?>
</td></tr>

<tr><td style="border-bottom:1px solid #cbcecb;border-left:1px solid #cbcecb;"><b>Email</b></td><td style="border-bottom:1px solid #cbcecb;border-right:1px solid #cbcecb;"><?php echo $rowInvoiceInfo[6];?></td><td></td><td><b>From</b></td><td><?php echo $rowInvoiceInfo[3];?></td></tr>
<tr height="10px"><td colspan="5" align="left">&nbsp;</td></tr>
</table>

<table width="950px" class="mystyle2" border="0">
<tr><td style="width:10%">Attention</td><td><?php echo $rowInvoiceInfo[5];?></td><td></td><td></td><td></td></tr>

<tr height="10px"><td colspan="5" align="left">&nbsp;</td></tr>

<tr><td colspan="5" align="left"><u><b><?php echo $rowInvoiceInfo[2];?></b></u></td></tr>
<tr height="5px"><td colspan="5" align="left">&nbsp;</td></tr>
<tr height="25"><td colspan="5" align="left"><div><?php echo $rowInvoiceInfo[14]; ?></div></td></tr>
	...
	if(mysqli_num_rows($resultInvoiceDetailInfo) > 0){
		...
		while($rowInvoiceDetailInfo = mysqli_fetch_row($resultInvoiceDetailInfo)){
			...
			if($rowInvoiceDetailInfo[4] == 1){
				...
				echo "<td style='width:550px'><b>".nl2br($rowInvoiceDetailInfo[1])."</b></td>";
				...
				echo "<td style='width:550px'>".nl2br($rowInvoiceDetailInfo[1])."</td>";
		...
		//total values
			...
			echo "<tr><td style='width:740px; border-right: 1px solid #cbcecb' colspan='4'></td><td style='width:140px' colspan='2' >Subtotal</td><td align='right' style='width:70px; border-right: 1px solid #cbcecb'>$rowInvoiceInfo[7]</td></tr>";
			echo "<tr><td style='width:740px; border-right: 1px solid #cbcecb' colspan='4'></td><td style='width:140px' colspan='2'>Disc Total</td><td align='right' style='width:70px; border-right: 1px solid #cbcecb'>$rowInvoiceInfo[8]</td></tr>";
			echo "<tr><td style='width:740px; border-right: 1px solid #cbcecb' colspan='4'></td><td style='width:140px' colspan='2'>Tax</td><td align='right' style='width:70px; border-right: 1px solid #cbcecb'>$rowInvoiceInfo[10]</td></tr>";
			echo "<tr><td style='width:740px; border-right: 1px solid #cbcecb' colspan='4'></td><td style='width:140px' colspan='2'>Total</td><td align='right' style='width:70px; border-right: 1px solid #cbcecb'>$rowInvoiceInfo[11]</td></tr>";
			echo "<tr><td style='width:740px; border-right: 1px solid #cbcecb' colspan='4'></td><td style='width:140px' colspan='2'>Round</td><td align='right' style='width:70px; border-right: 1px solid #cbcecb'>$rowInvoiceInfo[12]</td></tr>";
			$totalAmountInWords = "";			
			if($rowInvoiceInfo[11]<>0.00){$totalAmountInWords = convertNumber($rowInvoiceInfo[13]);}			
			echo "<tr><td style='width:740px; border-right: 1px solid #cbcecb' colspan='4'>$totalAmountInWords</td><td style='width:140px; border-bottom: 1px solid #cbcecb' colspan='2'>Grand Total</td><td align='right' style='width:70px; border-bottom: 1px solid #cbcecb; ; border-right: 1px solid #cbcecb'>$rowInvoiceInfo[13]</td></tr>";
		echo "</table>";
	}
?>
...
<td colspan="5" align="left"><div><?php echo $rowInvoiceInfo[4];?></div></td></tr>
...
<img src="images/QR_example.png" alt="QR Code" style="float: right; width: 100px; height: 100px;">
</td>
</tr>
<tr>
<td><div id="signature">
...
<tr><td><?php echo $rowInvoiceInfo[3];?></td><td></td><td>Signed & Company's stamp</td></tr>
</table>
<p>
<input type="button" class="noPrint" onclick="JavaScript:window.print();return false;" value="Print Invoice">
&nbsp;&nbsp;
<?php 
	echo "<input type=\"button\" class=\"noPrint\" onclick=\"createPDF($invoiceID, $customerID)\" value=\"Convert PDF\">";
?>
