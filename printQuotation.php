...
<script>
	function createPDF(x,y){
		...
		var url = 'printQuotationPDF.php';
		var params = 'idQuotation=' + quotationID + '&idCustomer=' + customerID;
		...
		xhr.onreadystatechange = function(){
			if(xhr.readyState === 4){
				...
				if(xhr.status === 200){
                    ...
                    link.href = url;
					var fileName = "quotation" +  "_" + Date.now() + ".pdf";
...
<p>
<input type="button" class="noPrint" onclick="JavaScript:window.print();return false;" value="Print Quotation">
<?php 
	echo "<input type=\"button\" class=\"noPrint\" onclick=\"createPDF($quotationID, $customerID)\" value=\"Convert PDF\">";
?>
</p>
