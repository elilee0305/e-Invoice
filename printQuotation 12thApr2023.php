...
<?php 
	if($rowCompanyName[4] ==! ""){
		...
		echo "<img src=".$logoLocation." width='142px' height='58px'>";
	}
?>
<h1><?php echo $rowCompanyName[0];?></h1>&nbsp;&nbsp;&nbsp;<h3><?php echo "Com No: ".$rowCompanyName[5];?></h3>
	...
	<div class="row">
		...
		<h4><?php echo $rowCompanyName[2];?></h4>
		<h4><?php echo $rowCompanyName[3];?></h4>
	</div>
</div>
...
<tr><td colspan="5" align="right"><b>QUOTATION</b></td></tr>
<tr><td style="width:10%;border-top:1px solid #cbcecb;border-left:1px solid #cbcecb;" bgcolor="#98ef98"></td><td bgcolor="#98ef98" style="width:50%;border-top:1px solid #cbcecb;border-right:1px solid #cbcecb;"></td><td style="width:15%;border-right:1px solid #cbcecb;">&nbsp;</td><td bgcolor="#98ef98" style="width:10%px;border-top:1px solid #cbcecb;"></td><td bgcolor="#98ef98" style="width:15%;border-top:1px solid #cbcecb;border-right:1px solid #cbcecb;"></td></tr>
<tr><td colspan="2" style="border-top:1px solid #cbcecb;border-left:1px solid #cbcecb;border-right:1px solid #cbcecb;"><b><?php echo $resultCustomerInfo2[0]?></b></td><td></td><td style="border-top:1px solid #cbcecb;border-left:1px solid #cbcecb;"><b>Quote No</b></td><td style="border-top:1px solid #cbcecb;border-right:1px solid #cbcecb;"><?php echo $rowQuotationInfo[0];?></td></tr>
<tr><td colspan="2" style="border-left:1px solid #cbcecb;border-right:1px solid #cbcecb;"><?php echo nl2br($resultCustomerInfo2[2]);?></td><td></td><td valign="top" style="border-left:1px solid #cbcecb;border-bottom:1px solid #cbcecb;"><b>Date</b></td><td valign="top" style="border-right:1px solid #cbcecb;border-bottom:1px solid #cbcecb;"><?php echo date("d/m/y",strtotime($rowQuotationInfo[1]))?></td></tr>
...
<tr><td style="border-bottom:1px solid #cbcecb;border-left:1px solid #cbcecb;"><b>Email</b></td><td style="border-bottom:1px solid #cbcecb;border-right:1px solid #cbcecb;"><?php echo $rowQuotationInfo[6];?></td><td></td><td><b>From</b></td><td><?php echo $rowQuotationInfo[3];?></td></tr>
...
<?php 
	...
	if(mysqli_num_rows($resultQuotationDetailInfo) > 0){
		...
		//total values
			...
			echo "<tr><td style='width:740px; border-right: 1px solid #cbcecb' colspan='4'></td><td style='width:140px' colspan='2' >Subtotal</td><td align='right' style='width:70px; border-right: 1px solid #cbcecb'>$rowQuotationInfo[7]</td></tr>";
			echo "<tr><td style='width:740px; border-right: 1px solid #cbcecb' colspan='4'></td><td style='width:140px' colspan='2'>Disc Total</td><td align='right' style='width:70px; border-right: 1px solid #cbcecb'>$rowQuotationInfo[8]</td></tr>";
			echo "<tr><td style='width:740px; border-right: 1px solid #cbcecb' colspan='4'></td><td style='width:140px' colspan='2'>Tax</td><td align='right' style='width:70px; border-right: 1px solid #cbcecb'>$rowQuotationInfo[10]</td></tr>";
			echo "<tr><td style='width:740px; border-right: 1px solid #cbcecb' colspan='4'></td><td style='width:140px' colspan='2'>Total</td><td align='right' style='width:70px; border-right: 1px solid #cbcecb'>$rowQuotationInfo[11]</td></tr>";
			echo "<tr><td style='width:740px; border-right: 1px solid #cbcecb' colspan='4'></td><td style='width:140px' colspan='2'>Round</td><td align='right' style='width:70px; border-right: 1px solid #cbcecb'>$rowQuotationInfo[12]</td></tr>";
			$totalAmountInWords = "";			
			if($rowQuotationInfo[11]<>0.00){$totalAmountInWords = convertNumber($rowQuotationInfo[13]);}			
			echo "<tr><td style='width:740px; border-right: 1px solid #cbcecb' colspan='4'>$totalAmountInWords</td><td style='width:140px; border-bottom: 1px solid #cbcecb' colspan='2'>Grand Total</td><td align='right' style='width:70px; border-bottom: 1px solid #cbcecb; ; border-right: 1px solid #cbcecb'>$rowQuotationInfo[13]</td></tr>";
		echo "</table>";
	}
