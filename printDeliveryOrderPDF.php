<?php
	...
	if(isset($_POST['idDeliveryOrder'])){		
		$deliveryOrderID = $_POST['idDeliveryOrder'];
...
function convertDigit($digit)
{
	...
	$pdf->SetTitle('Delivery Order PDF');
	...
	<body style=\"font-size: 9pt\">
		...
		<tr><td colspan=\"5\" align=\"right\" style=\"font-size: 11.25pt;\">DELIVERY ORDER</td></tr>
		...
		<tr><td colspan=\"2\" style=\"border-top: 0.75pt solid #cbcecb; border-left:0.75pt solid #cbcecb; border-right: 0.75pt solid #cbcecb;\"><b>{$resultCustomerInfo2[0]}</b></td><td ></td><td style=\"border-top:0.75pt solid #cbcecb;border-left:0.75pt solid #cbcecb;\">DO No</td><td style=\"border-top:0.75pt solid #cbcecb;border-right:0.75pt solid #cbcecb;\">{$rowDeliveryOrderInfo[0]}</td></tr>
		";


		$value1 = nl2br($resultCustomerInfo2[2]);
		$value2 = date("d/m/y",strtotime($rowDeliveryOrderInfo[1]));
		...
		<tr><td style=\"border-bottom: 0.75pt solid #cbcecb; border-left:0.75pt solid #cbcecb;\"><b>Email</b></td><td style=\"border-bottom: 0.75pt solid #cbcecb;border-right: 0.75pt solid #cbcecb;\">{$rowDeliveryOrderInfo[6]}</td><td></td><td><b>From</b></td><td>{$rowDeliveryOrderInfo[3]}</td></tr>
		<tr height=\"3pt\"><td colspan=\"5\" align=\"left\">&nbsp;</td></tr>
		</table>
		
		<table width=\"570pt\" style=\"border-collapse: collapse; page-break-inside: avoid;\">
		<tr><td style=\"width: 57pt;\">Attention</td><td colspan=\"4\" style=\"width: 513pt;\">{$rowDeliveryOrderInfo[5]}</td></tr>
		<tr><td colspan=\"5\" align=\"left\">&nbsp;</td></tr>
		";


		//show only if title got value
		if($rowDeliveryOrderInfo[2] !== ""){
			$htmlPage .= "<tr><td colspan=\"5\" align=\"left\" style=\"min-height: 30pt;\"><u><b>{$rowDeliveryOrderInfo[2]}</b></u></td></tr>
			<tr><td colspan=\"5\" align=\"left\" style=\"min-height: 20pt;\">&nbsp;</td></tr>
			";
		}
		//show only if remark got value		
		if($rowDeliveryOrderInfo[14] !== ""){
			$htmlPage .= "<tr><td colspan=\"5\" align=\"left\" style=\"min-height: 30pt;\">{$rowDeliveryOrderInfo[14]}</td></tr>
			<tr><td colspan=\"5\" align=\"left\"></td></tr>";
		}
	...
	if(mysqli_num_rows($resultDeliveryOrderDetailInfo) > 0){
			...
			while($rowDeliveryOrderDetailInfo = mysqli_fetch_row($resultDeliveryOrderDetailInfo)){
				...
				if($rowDeliveryOrderDetailInfo[4] == 1){
					//Bold
					$value3 = nl2br($rowDeliveryOrderDetailInfo[0]);
					$value4 = nl2br($rowDeliveryOrderDetailInfo[1]);
					if($numOfRows == $counter){
						//last row
						$htmlPage .= "<td style=\"width: 25pt; text-align: right; border-left: 0.75pt solid #cbcecb; border-bottom: 0.75pt solid #cbcecb;\">";
					}else{
					...
					$htmlPage .= "					
						...
						if($numOfRows == $counter){
						//last row
							$htmlPage .= "<td style=\"width: 320pt; vertical-align: top; border-bottom: 0.75pt solid #cbcecb;\">";
						}else{
							$htmlPage .= "<td style=\"width: 320pt; vertical-align: top;\">";
							
						}
						
						$htmlPage .= "<table width=\"100%\" height=\"100%\" cellpadding=\"3pt\">
							<tr>
								<td><b>{$value4}</b></td>
							</tr>
						</table>
					...
					if($rowDeliveryOrderDetailInfo[2] == 0.00){
						if($numOfRows == $counter){
							//last row
							$htmlPage .= "<td style=\"width: 40pt; text-align: right; border-bottom: 0.75pt solid #cbcecb;\">";
						}else{
						...
						$value5 = nl2br($rowDeliveryOrderDetailInfo[2]);
					...
					$value6 = nl2br($rowDeliveryOrderDetailInfo[3]);
					if($numOfRows == $counter){
						//last row
						$htmlPage .= "<td style=\"width: 40pt; border-bottom: 0.75pt solid #cbcecb;\">";
					}else{
					...
					if($rowDeliveryOrderDetailInfo[5] == 0.00){
						if($numOfRows == $counter){
							//last row
							$htmlPage .= "<td style=\"width: 55pt; text-align: right; border-bottom: 0.75pt solid #cbcecb;\">";
						}else{
						...
						$value7 = nl2br($rowDeliveryOrderDetailInfo[5]);
						if($numOfRows == $counter){
							//last row
							$htmlPage .= "<td style=\"width: 55pt; text-align: right; border-bottom: 0.75pt solid #cbcecb;\">";
						}else{
					...
					if($rowDeliveryOrderDetailInfo[6] == 0.00){
						if($numOfRows == $counter){
							//last row
							$htmlPage .= "<td style=\"width: 35pt; text-align: right; border-bottom: 0.75pt solid #cbcecb;\">";
						}else{
						...
						$value8 = nl2br($rowDeliveryOrderDetailInfo[6]);
						if($numOfRows == $counter){
							//last row
							$htmlPage .= "<td style=\"width: 35pt; text-align: right; border-bottom: 0.75pt solid #cbcecb;\">";
						}else{
					...
					if($rowDeliveryOrderDetailInfo[7] == 0.00){
						if($numOfRows == $counter){
							//last row
							$htmlPage .= "<td style=\"width: 55pt; text-align: right; border-right: 0.75pt solid #cbcecb; border-bottom: 0.75pt solid #cbcecb;\">";
						}else{
						...
						$value9 = nl2br($rowDeliveryOrderDetailInfo[7]);
						if($numOfRows == $counter){
							//last row
							$htmlPage .= "<td style=\"width: 55pt; text-align: right; border-right: 0.75pt solid #cbcecb; border-bottom: 0.75pt solid #cbcecb;\">";
						}else{
					...
					$value10 = nl2br($rowDeliveryOrderDetailInfo[0]);
					$value11 = nl2br($rowDeliveryOrderDetailInfo[1]);
					if($numOfRows == $counter){
						//last row
						$htmlPage .= "<td style=\"width: 25pt; vertical-align: top; text-align: right; border-left: 0.75pt solid #cbcecb; border-bottom: 0.75pt solid #cbcecb;\">";					
					}else{
					...
					if($numOfRows == $counter){
						//last row
						$htmlPage .= "<td style=\"width: 320pt; border-bottom: 0.75pt solid #cbcecb;\">";
					}else{
						$htmlPage .= "<td style=\"width: 320pt;\">";
					}
					...
					if($rowDeliveryOrderDetailInfo[2] == 0.00){
						...
						$value12 = nl2br($rowDeliveryOrderDetailInfo[2]);
						if($numOfRows == $counter){
							//last row
							$htmlPage .= "<td style=\"width: 40pt; text-align: right; border-bottom: 0.75pt solid #cbcecb;\">";
						}else{
					...
					$value13 = nl2br($rowDeliveryOrderDetailInfo[3]);
					...
					if($rowDeliveryOrderDetailInfo[5] == 0.00){
						...
						$value14 = nl2br($rowDeliveryOrderDetailInfo[5]);
						if($numOfRows == $counter){
							//last row
							$htmlPage .= "<td style=\"width: 55pt; text-align: right; border-bottom: 0.75pt solid #cbcecb;\">";
						}else{
					...
					if($rowDeliveryOrderDetailInfo[6] == 0.00){
						...
						$value15 = nl2br($rowDeliveryOrderDetailInfo[6]);
						if($numOfRows == $counter){
							//last row
							$htmlPage .= "<td style=\"width: 35pt; text-align: right; border-bottom: 0.75pt solid #cbcecb;\">";
						}else{
					...
					if($rowDeliveryOrderDetailInfo[7] == 0.00){
						...
						$value16 = nl2br($rowDeliveryOrderDetailInfo[7]);
						if($numOfRows == $counter){
							//last row
							$htmlPage .= "<td style=\"width: 55pt; text-align: right; border-right: 0.75pt solid #cbcecb; border-bottom: 0.75pt solid #cbcecb;\">";
						}else{
		...
		$htmlPage .= "
			...
			<tr><td colspan=\"5\" align=\"left\">{$rowDeliveryOrderInfo[4]}</td></tr>
			...
			<tr><td>{$rowDeliveryOrderInfo[3]}</td><td></td><td>Signed & Company's stamp</td></tr>
			</table>
			</body>	
			</html>	
		";
