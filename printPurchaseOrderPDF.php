<?php
	...
	if(isset($_POST['idPurchaseOrder'])){		
		$purchaseOrderID = $_POST['idPurchaseOrder'];
...
function convertDigit($digit)
{
	...
	<body style=\"font-size: 9pt\">
		...
		<tr><td colspan=\"5\" align=\"right\" style=\"font-size: 11.25pt;\">PURCHASE ORDER</td></tr>
		...
		<tr><td colspan=\"2\" style=\"border-top: 0.75pt solid #cbcecb; border-left:0.75pt solid #cbcecb; border-right: 0.75pt solid #cbcecb;\"><b>{$resultCustomerInfo2[0]}</b></td><td ></td><td style=\"border-top:0.75pt solid #cbcecb;border-left:0.75pt solid #cbcecb;\">PO No</td><td style=\"border-top:0.75pt solid #cbcecb;border-right:0.75pt solid #cbcecb;\">{$rowPurchaseOrderInfo[0]}</td></tr>
		";
	
		$value1 = nl2br($resultCustomerInfo2[2]);
		$value2 = date("d/m/y",strtotime($rowPurchaseOrderInfo[1]));
		...
		<tr><td style=\"border-bottom: 0.75pt solid #cbcecb; border-left:0.75pt solid #cbcecb;\"><b>Email</b></td><td style=\"border-bottom: 0.75pt solid #cbcecb;border-right: 0.75pt solid #cbcecb;\">{$rowPurchaseOrderInfo[6]}</td><td></td><td><b>From</b></td><td>{$rowPurchaseOrderInfo[3]}</td></tr>
		<tr height=\"3pt\"><td colspan=\"5\" align=\"left\">&nbsp;</td></tr>
		</table>
		
		<table width=\"570pt\" style=\"border-collapse: collapse; page-break-inside: avoid;\">
		<tr><td style=\"width: 57pt;\">Attention</td><td colspan=\"4\" style=\"width: 513pt;\">{$rowPurchaseOrderInfo[5]}</td></tr>
		...
		if($rowPurchaseOrderInfo[2] !== ""){
			$htmlPage .= "<tr><td colspan=\"5\" align=\"left\" style=\"min-height: 30pt;\"><u><b>{$rowPurchaseOrderInfo[2]}</b></u></td></tr>
			<tr><td colspan=\"5\" align=\"left\" style=\"min-height: 20pt;\">&nbsp;</td></tr>
			";
		}
		//show only if remark got value		
		if($rowPurchaseOrderInfo[14] !== ""){
			$htmlPage .= "<tr><td colspan=\"5\" align=\"left\" style=\"min-height: 30pt;\">{$rowPurchaseOrderInfo[14]}</td></tr>
			<tr><td colspan=\"5\" align=\"left\"></td></tr>";
		}
		...
		if(mysqli_num_rows($resultPurchaseOrderDetailInfo) > 0){
			...
			while($rowPurchaseOrderDetailInfo = mysqli_fetch_row($resultPurchaseOrderDetailInfo)){
				...
				if($rowPurchaseOrderDetailInfo[4] == 1){
					//Bold
					$value3 = nl2br($rowPurchaseOrderDetailInfo[0]);
					$value4 = nl2br($rowPurchaseOrderDetailInfo[1]);
					...
					if($rowPurchaseOrderDetailInfo[2] == 0.00){
						...
						$value5 = nl2br($rowPurchaseOrderDetailInfo[2]);
						$htmlPage .= "<td style=\"width: 40pt; text-align: right;\">
					...
					$value6 = nl2br($rowPurchaseOrderDetailInfo[3]);
					...
					if($rowPurchaseOrderDetailInfo[5] == 0.00){
						...
						$value7 = nl2br($rowPurchaseOrderDetailInfo[5]);
						$htmlPage .= "<td style=\"width: 55pt; text-align: right;\">
							<table width=\"100%\" height=\"100%\" cellpadding=\"3pt\">
								<tr>
									<td><b>{$value7}</b></td>
					...
					if($rowPurchaseOrderDetailInfo[6] == 0.00){
						...
						$value8 = nl2br($rowPurchaseOrderDetailInfo[6]);
						$htmlPage .= "<td style=\"width: 35pt; text-align: right;\">
							<table width=\"100%\" height=\"100%\" cellpadding=\"3pt\">
								<tr>
									<td><b>{$value8}</b></td>
					...
					if($rowPurchaseOrderDetailInfo[7] == 0.00){
						...
						$value9 = nl2br($rowPurchaseOrderDetailInfo[7]);
						$htmlPage .= "<td style=\"width: 55pt; text-align: right; border-right: 0.75pt solid #cbcecb\">
							<table width=\"100%\" height=\"100%\" cellpadding=\"3pt\">
								<tr>
									<td><b>{$value9}</b></td>
					...
					$value10 = nl2br($rowPurchaseOrderDetailInfo[0]);
					$value11 = nl2br($rowPurchaseOrderDetailInfo[1]);
					...
					if($rowPurchaseOrderDetailInfo[2] == 0.00){
						...
						$value12 = nl2br($rowPurchaseOrderDetailInfo[2]);
						$htmlPage .= "<td style=\"width: 40pt; text-align: right;\">
							<table width=\"100%\" height=\"100%\" cellpadding=\"3pt\">
								<tr>
									<td>{$value12}</td>
					...
					$value13 = nl2br($rowPurchaseOrderDetailInfo[3]);
					$htmlPage .= "<td style=\"width: 40pt;\">
								<table width=\"100%\" height=\"100%\" cellpadding=\"3pt\">
									<tr>
										<td>{$value13}</td>
					...
					if($rowPurchaseOrderDetailInfo[5] == 0.00){
						...
						$value14 = nl2br($rowPurchaseOrderDetailInfo[5]);
						$htmlPage .= "<td style=\"width: 55pt; text-align: right;\">
							<table width=\"100%\" height=\"100%\" cellpadding=\"3pt\">
								<tr>
									<td>{$value14}</td>
					...
					if($rowPurchaseOrderDetailInfo[6] == 0.00){
						...
						$value15 = nl2br($rowPurchaseOrderDetailInfo[6]);
						$htmlPage .= "<td style=\"width: 35pt; text-align: right;\">
							<table width=\"100%\" height=\"100%\" cellpadding=\"3pt\">
								<tr>
									<td>{$value15}</td>
					...
					if($rowPurchaseOrderDetailInfo[7] == 0.00){
						...
						$value16 = nl2br($rowPurchaseOrderDetailInfo[7]);
						$htmlPage .= "<td style=\"width: 55pt; text-align: right; border-right: 0.75pt solid #cbcecb\">
							<table width=\"100%\" height=\"100%\" cellpadding=\"3pt\">
								<tr>
									<td>{$value16}</td>
			...
			<tr><td style=\"width: 400pt; text-align: left; border-right: 0.75pt solid #cbcecb; border-top: 0.75pt solid #cbcecb\" colspan='4'></td><td style=\"width: 105pt; border-top: 0.75pt solid #cbcecb\" colspan='2' >Subtotal</td><td style=\"width: 65pt; text-align: right; border-right: 0.75pt solid #cbcecb; border-top: 0.75pt solid #cbcecb\">{$rowPurchaseOrderInfo[7]}</td></tr>
			<tr><td style=\"width: 400pt; text-align: left; border-right: 0.75pt solid #cbcecb\" colspan='4'></td><td style=\"width: 105pt\" colspan='2'>Disc Total</td><td  style=\"width: 65pt; text-align: right; border-right: 0.75pt solid #cbcecb\">{$rowPurchaseOrderInfo[8]}</td></tr>
			<tr><td style=\"width: 400pt; text-align: left; border-right: 0.75pt solid #cbcecb\" colspan='4'></td><td style=\"width: 105pt\" colspan='2'>Tax</td><td style=\"width: 65pt; text-align: right; border-right: 0.75pt solid #cbcecb\">{$rowPurchaseOrderInfo[10]}</td></tr>
			<tr><td style=\"width: 400pt; text-align: left; border-right: 0.75pt solid #cbcecb\" colspan='4'></td><td style=\"width: 105pt\" colspan='2'>Total</td><td style=\"width: 65pt; text-align: right; border-right: 0.75pt solid #cbcecb\">{$rowPurchaseOrderInfo[11]}</td></tr>
			<tr><td style=\"width: 400pt; text-align: left; border-right: 0.75pt solid #cbcecb\" colspan='4'></td><td style=\"width: 105pt\" colspan='2'>Round</td><td style=\"width: 65pt; text-align: right; border-right: 0.75pt solid #cbcecb\">{$rowPurchaseOrderInfo[12]}</td></tr>";
			
			$totalAmountInWords = "";
			if($rowPurchaseOrderInfo[11]<>0.00){$totalAmountInWords = convertNumber($rowPurchaseOrderInfo[13]);}
			
			$htmlPage .= "
			<tr><td style = \"width:400pt; border-right: 0.75pt solid #cbcecb\" colspan='4'>{$totalAmountInWords}</td><td style=\"width:105pt; border-bottom: 0.75pt solid #cbcecb\" colspan='2'>Grand Total</td><td align='right' style=\"width:65pt; border-bottom: 0.75pt solid #cbcecb; text-align: right; border-right: 0.75pt solid #cbcecb\">{$rowPurchaseOrderInfo[13]}</td></tr>		
			</table>			
		...
		$htmlPage .= "
			...
			<tr><td colspan=\"5\" align=\"left\">{$rowPurchaseOrderInfo[4]}</td></tr>
			...
			<tr><td>{$rowPurchaseOrderInfo[3]}</td><td></td><td>Signed & Company's stamp</td></tr>
			</table>
			</body>	
			</html>	
		";
