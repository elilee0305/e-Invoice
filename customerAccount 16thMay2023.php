...
<?php 
	if(mysqli_num_rows($resultCustomerList) > 0){
		...
		echo "<table cellpadding=0 border=0 height='25' width='650'><tr><td align='left'><span id='noOfRecordSpan'>".mysqli_num_rows($resultCustomerList)."&nbsp;records</span></td><td></td></tr></table>";
		...
		echo "<thead><tr>";
		echo "<td style='width:580'><p style=\"font-size:13px\"><b>Name</b></p></td>";		
		echo "<td style='width:40'><p style=\"font-size:13px\"><b>Acc</b></p></td>";			
		echo "</tr></thead>";
		while($rowCustomerList = mysqli_fetch_row($resultCustomerList)){
			...
			echo "<td style='width:580'><p style=\"font-size:13px\">$rowCustomerList[1]</p></td>";
			echo "<td style='width:30'><p style=\"font-size:13px\"><a href='' onclick=\" return ShowCustomerDetail($customerID)\">Acc</a></p></td>";
			echo "</tr>";
		}		
		echo "</table>";
			
	}else{
		echo "<table width=\"610\" border=\"0\" cellpadding=\"0\"><tr height=\"25\"><td>&nbsp;</td></tr></table>";
		echo "<table cellpadding='0' border='1' class='mystyle'>";
		echo "<thead><tr>";
		echo "<td style='width:580'><p style=\"font-size:13px\"><b>Name</b></p></td>";		
		echo "<td style='width:30'><p style=\"font-size:13px\"><b>Acc</b></p></td>";			
		echo "</tr></thead>";
		echo "</table>"; 
	}
?>
...
<tr height="15"><td>
<input style="font-size:13px" id="demo1" type="text" name="accountDate1" size="10" value="<?php 
	if(isset($_POST['Submit'])){
...
<input style="font-size:13px" id="demo2" type="text" name="accountDate2" size="10" value="<?php 
	if(isset($_POST['Submit'])){
...
<tr height="57"><td>&nbsp;</td></tr>
 ...
 <table width="610" cellpadding="0" border="1" id="myTable" class='mystyle2'>
	<thead><tr><td style='width:73'><b>Date</b></td><td style='width:85'><b>Reference</b></td><td style='width:295'><b>Description</b></td><td style='width:70'><b>Debit</b></td><td style='width:70'><b>Credit</b></td></thead></tr>
	<tbody>
			<!--<td></td><td></td>-->
	</tbody>
