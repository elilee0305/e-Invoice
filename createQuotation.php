<?php 
	...
	if(isset($_POST['Submit'])){
		...
		'$quotationTerms', '$customerAttentionValue', '$customerEmailValue', '$subTotal', 
...
<tr><td colspan="4" align="center"><h1>Create Quotation</h1></td><td>&nbsp;</td></tr>
<tr><td colspan="4" align="left">

<div class="search-box">
	<input type="text" id="search" autocomplete="off" name="searchname" placeholder="Search Customer">
...
</td><td><input type="text" name="quotationDuplicate" id="quotationDuplicate" size="12" maxlength="30">&nbsp;<img src="images/duplicatefinal.png" onclick="GetDuplicateInfo()"><span id="duplicateInfo" style="color:blue;font-size:12px"></span></td></tr>
<!--<tr><td></td><td></td><td>&nbsp;</td><td></td><td></td></tr>-->
<tr><td>To</td><td><input type="customerNameValue" id="customerNameValue" size="60" value="<?php if(($duplicateStatus==1)&&($customerID <> 0)){echo $rowCustomerInfo[0];}?>" readonly></td><td></td><td>Quotation No</td><td><input type="text" name="quotationNo" id="quotationNo" size="12" maxlength="30" value="<?php echo $strLastQuotationNo;?>" onchange="CheckQuotationNo()" autofocus><span id="info"><img border="0" src="images/Terminate.png"></span></td></tr>

<tr><td>Attention</td><td><input type="text" name="customerAttentionValue" id="customerAttentionValue" size="40" maxlength="100" value="<?php if(($duplicateStatus==1)&&($customerID <> 0)){echo $rowCustomerInfo[3];}?>"></td><td></td><td>Date</td><td><input id="demo2" type="text" name="quotationDate" size="10" value="<?php echo date('d/m/Y');?>" readonly>&nbsp;</td></tr>
<tr><td>Address</td><td><input type="text" name="customerAddressValue" id="customerAddressValue" size="70" value="<?php if(($duplicateStatus==1)&&($customerID <> 0)){echo $rowCustomerInfo[4];}?>" readonly></td><td></td><td>From</td><td><input type="text" name="quotationFrom" size="20" maxlength="50"></td></tr>
...
<tr><td colspan="5" align="left">&nbsp;<input type="text" name="quotationTitle" maxlength="200" size="150" placeholder="Quotation Title"></td></tr>
...
<?php
	if($duplicateStatus==1){	
		if(mysqli_num_rows($resultQuotationDetailInfo) > 0){
			echo "<table width='1200px' cellpadding='0px' border='1px' id='empTableTotal' class='mystyle'>";
...
<table width="1200px" cellpadding="0" border="1" class="mystyle">
<tr><td colspan="5" align="left"><textarea name="quotationTerms" id="quotationTerms"><?php if($duplicateStatus==1){echo $rowQuotationInfo[1];}else{echo $rowCompanyName[1];} ?></textarea>
...
<p><input type="submit" id="bt" name="Submit" value="Create Quotation" <?php if($duplicateStatus==1){echo "disabled";}?>></p>
