...
<table width="1000" border="0" cellpadding="0" align="center"><tr height="40"><td align="left" width="350"><h1>Create Credit Note</h1></td><td width="350"></td></tr></table>
...
<form action="invoiceListCreditNote.php" id="invoiceListCreditNote" method="post">
...
<?php 
	if(mysqli_num_rows($resultInvoiceList) > 0){
		...
		echo "<thead><tr>";
		echo "<td style='width:150'><p style=\"font-size:12px\"><b>Invoice No</b></p></td>";
		echo "<td style='width:150'><p style=\"font-size:12px\"><b>Date</b></p></td>";
		echo "<td style='width:770'><p style=\"font-size:12px\"><b>Customer</b></p></td>";
		echo "<td style='width:70'><p style=\"font-size:12px\"><b>Total</b></p></td>";
		echo "<td style='width:150'><p style=\"font-size:12px\"><b>Credit Note</b></p></td>";
		echo "</tr></thead>";
		...
		while($rowInvoiceList = mysqli_fetch_row($resultInvoiceList)){
			...
			echo "<td style='width:150'><p style=\"font-size:12px\">$rowInvoiceList[3]</p></td>";			
			echo "<td style='width:150'><p style=\"font-size:12px\">".date("d/m/Y",strtotime($rowInvoiceList[4]))."</p></td>";
			echo "<td style='width:770'><p style=\"font-size:12px\">$rowInvoiceList[1]</p></td>";	
			echo "<td style='width:70'><p style=\"font-size:12px\">$rowInvoiceList[6]</p></td>";
			echo "<td style='width:150'><p style=\"font-size:12px\"><a href='createCreditNote.php?idInvoiceDuplicate=$rowInvoiceList[2]&idCustomer=$rowInvoiceList[0]'>credit note</a></p></td>";			
			echo "</tr>";			
		}		
		echo "</table>";
	}
